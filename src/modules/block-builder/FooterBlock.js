	...
	<Layout type="ROW" opt={{ bgColor: '#222', classes: 'footer' }}>
		...
		>
			<div className="footer-infos">
				...
				<p>
					A Descola é uma escola de cursos online que cria grandes experiências
					de aprendizagem para transformar as pessoas ao longo de suas vidas.
					Selecionamos temas e professores e construímos conteúdos para que você
					desenvolva Power Skills.
				</p>
			...
			<div className="tag-list-wrapper">
				...
				<a href="https://descola.org/cursos?tag=produtividade" className="tag">
					Produtividade
				</a>
